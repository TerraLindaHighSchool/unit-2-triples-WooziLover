...
public class CardTest {
    Card[] one = {
            ...
            new Card(Card.Shape.SQUARE, Card.Color.GREEN, 3, 3, R.drawable.triangle_red_3_2, R.drawable.triangle_red_1_2_selected)};
    @Test
    ...
    public void getImageID() {
        int[] t = {R.drawable.circle_blue_1_0, R.drawable.square_green_1_1, R.drawable.triangle_red_3_2};
        int[] s = new int[3];
        for (int i = 0; i < one.length; i++) {
    ...
    public void getSelectedImageID() {
        int[] t = {R.drawable.circle_blue_2_1_selected, R.drawable.square_green_3_0_selected, R.drawable.triangle_red_1_2_selected};
        int[] s = new int[3];
        for(int i = 0; i < one.length;i++) {
